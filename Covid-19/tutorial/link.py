...
def update_small_cards(start_date, end_date):
    ...
    TOTAL_PV = People_vaccinated.loc[People_vaccinated['date'] == end_date, 'cumPeopleVaccinatedFirstDoseByPublishDate'].iloc[0]
    TOTAL_PV = int(TOTAL_PV)

    return TOTAL_PV, compns_num, in_num, out_num, reactns_num
